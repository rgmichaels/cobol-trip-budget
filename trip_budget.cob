...
*> ONE fixed-width money display used everywhere
01 WS-MONEY-EDIT               PIC Z,ZZZ,ZZ9.99.

*> Fixed-width category column so ":" and "$" align
01 WS-CAT-DISP                 PIC X(20) VALUE SPACES.
...
MAIN-PARA.
    *> Command-line file input (defaults to data/expenses.csv)
    ...
    MOVE TOTAL-AMOUNT TO WS-MONEY-EDIT
    DISPLAY "Total          : $" WS-MONEY-EDIT.

    MOVE AVG-AMOUNT TO WS-MONEY-EDIT
    DISPLAY "Avg            : $" WS-MONEY-EDIT.

    MOVE MAX-AMOUNT TO WS-MONEY-EDIT
    DISPLAY "Max            : $" WS-MONEY-EDIT.
    DISPLAY "-------------------------------".
...
PROCESS-LINE.
    ...
    *> Echo accepted line (fixed category column aligns ":" and "$")
    MOVE SPACES TO WS-CAT-DISP
    MOVE FUNCTION TRIM(WS-CATEGORY) TO WS-CAT-DISP
    MOVE WS-AMOUNT TO WS-MONEY-EDIT
    DISPLAY WS-DATE "  " WS-CAT-DISP ": $" WS-MONEY-EDIT.
...
PRINT-CATEGORY-REPORT.
    ...
    PERFORM UNTIL WS-CAT-IDX > CAT-COUNT
        MOVE SPACES TO WS-CAT-DISP
        MOVE FUNCTION TRIM(CAT-NAME(WS-CAT-IDX)) TO WS-CAT-DISP

        MOVE CAT-SUM(WS-CAT-IDX) TO WS-MONEY-EDIT
        DISPLAY WS-CAT-DISP ": $" WS-MONEY-EDIT
